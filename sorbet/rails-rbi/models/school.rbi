...
class School::ActiveRecord_Relation < ActiveRecord::Relation
  include School::ModelRelationShared
  extend T::Generic
...
class School < ApplicationRecord
  extend T::Sig
  extend T::Generic
  extend School::ModelRelationShared
  include School::InstanceMethods
  Elem = type_template(fixed: School)
end

module School::InstanceMethods
  extend T::Sig
  ...
  sig { params(value: String).void }
  def school_type=(value); end

  sig { params(args: T.untyped).returns(T::Boolean) }
  def school_type?(*args); end
...
class School
  ...
  sig { returns(::Homeroom::ActiveRecord_Associations_CollectionProxy) }
  def homerooms(); end

  sig { params(value: T.any(T::Array[::Homeroom], ::Homeroom::ActiveRecord_Associations_CollectionProxy)).void }
  def homerooms=(value); end
...
module School::ModelRelationShared
  extend T::Sig
