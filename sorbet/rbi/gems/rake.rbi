...
class Rake::FileList
  ...
  def to_a; end
  def to_ary; end
  def to_ber(*args, &block); end
  def to_ber_appsequence(*args, &block); end
  def to_ber_contextspecific(*args, &block); end
  def to_ber_control(*args, &block); end
  def to_ber_oid(*args, &block); end
  def to_ber_sequence(*args, &block); end
  def to_ber_set(*args, &block); end
