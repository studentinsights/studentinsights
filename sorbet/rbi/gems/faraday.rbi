...
class Faraday::RequestOptions < Anonymous_Faraday_Options_22
  def []=(key, value); end
end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_23
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_24
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_25
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_26
  def [](key); end
  def []=(key, value); end
  def clear_body; end
