Rails.application.routes.draw do
  ...
  # Devise, see https://github.com/plataformatec/devise#configuring-routes
  # Ordering of these within this file matters for precedence, and
  # changing it can cause redirect loops.
