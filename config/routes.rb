Rails.application.routes.draw do
  ...
  get '/api/students/:id/reader_profile_cohort_json' => 'profile#reader_profile_cohort_json'
  put '/api/students/:student_id/event_note_drafts/:draft_key' => 'event_notes#event_note_draft_json'
  ...
  # Course Breakdowns
  get '/api/course_breakdown/:school_id/show_json' => 'course_breakdown#show_json'
  ...
  # Course Breakdown
  get '/course_breakdown/:school_id' => 'ui#ui'
