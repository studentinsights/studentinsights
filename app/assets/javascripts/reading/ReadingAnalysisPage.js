...
export default class ReadingAnalysisPage extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="ReadingAnalysisPage" style={styles.flexVertical}>
        <GenericLoader
...
ReadingAnalysisPage.propTypes ={
  schoolId: PropTypes.string.isRequired,
  grade: PropTypes.string.isRequired
};


export class ReadingAnalysisPageView extends React.Component {
  constructor(props) {
    super(props);
...
ReadingAnalysisPageView.contextTypes = {
  districtKey: PropTypes.string.isRequired,
  nowFn: PropTypes.func.isRequired
};
ReadingAnalysisPageView.propTypes = {
  schoolId: PropTypes.string.isRequired,
  grade: PropTypes.string.isRequired,
