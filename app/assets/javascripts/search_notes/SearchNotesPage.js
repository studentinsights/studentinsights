...
export default class SearchNotesPage extends React.Component {
  ...
  render() {
    return (
      <div className="SearchNotesPage" style={styles.flexVertical}>
        <GenericLoader
  ...
  renderStudents(json) {
    const {students} = json;
    return <SearchNotesPageView students={students} />;
  }
}
...
export class SearchNotesPageView extends React.Component {
  constructor(props) {
    super(props);
...
SearchNotesPageView.contextTypes = {
  districtKey: PropTypes.string.isRequired
};
SearchNotesPageView.propTypes = {
