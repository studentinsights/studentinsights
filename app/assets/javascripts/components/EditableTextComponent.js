...
// whitelisted.
function htmlToSanitizedHTML(html, sanitizer) {
  const node = document.createElement('div');
  const newNode = document.createElement('div');

  node.innerHTML = html;
  const sanitizedDocumentFragment = sanitizer.clean_node(node);
...
class EditableTextComponent extends React.Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return currentHTML !== htmlToSanitizedHTML(currentHTML, this.sanitizer)
