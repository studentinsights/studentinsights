  ...
  return (
    <div className="BoxAndWhisker" title={JSON.stringify({min, p25, p50, p75, max})} style={{height: 30, ...style}}>
      <div style={{position: 'relative', width: '100%', height: '100%'}}>
        <div style={{position: 'absolute', left: scale(min - labelWidth/2), width: scale(labelWidth), textAlign: 'center', fontSize: 10, top: 15}}>{min}</div>
        <div style={{position: 'absolute', left: scale(max - labelWidth/2), width: scale(labelWidth), textAlign: 'center', fontSize: 10, top: 15}}>{max}</div>
        <div style={{position: 'absolute', left: scale(p50 - labelWidth/2), width: scale(labelWidth), textAlign: 'center', fontSize: 10, top: 15}}>{p50}</div>
