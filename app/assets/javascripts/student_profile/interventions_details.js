  ...
  */
  var InterventionsDetails = window.shared.InterventionsDetails = React.createClass({
    ...
    getNotesHelpContent: function(){
      // A hack to create maintainable multiline string in JS.
      // We create an anonymous function, then grab the string from its serialization.
      // DON'T CHANGE the format of the comment -- it will affect the rendered string.
      return (function(){/*
