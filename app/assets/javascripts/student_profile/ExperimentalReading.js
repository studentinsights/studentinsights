...
export default class ExperimentalReading extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <div className="ExperimentalReading" style={styles.flexVertical}>
        <GenericLoader
  ...
  renderStudents(json) {
    const {students} = json;
    return <ExperimentalReadingView students={students} />;
  }
}


export class ExperimentalReadingView extends React.Component {
  constructor(props) {
    super(props);
...
ExperimentalReadingView.contextTypes = {
  districtKey: PropTypes.string.isRequired
};
ExperimentalReadingView.propTypes = {
