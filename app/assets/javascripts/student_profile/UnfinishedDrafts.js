...
function fetchDraftsForStudentProfile() {

}
export default class UnfinishedDrafts extends React.Component {
  fetchDraftsForStudentProfile() {
  ...
  render() {
    return (
      <div className="UnfinishedDrafts">
        <GenericLoader
          promiseFn={this.fetchDraftsForStudentProfile}
          render={json => (
...
UnfinishedDrafts.defaultProps = {
  forceShowingAllNotes: false,
  defaultSchoolYearsBack
};
UnfinishedDrafts.contextTypes = {
