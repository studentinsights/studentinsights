...
export default class InsightFromGenericImportedForm extends React.Component {
  render() {
...
InsightFromGenericImportedForm.propTypes = {
...
export const FROM_GENERIC_IMPORTED_FORM = 'from_generic_imported_form';
