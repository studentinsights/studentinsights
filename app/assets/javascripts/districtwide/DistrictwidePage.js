export function() {
  render() {
    const columnClassName = '' // <% unless current_educator.admin? %>only-column<% end %>
  ...
  renderProjectLeadLinks() {
    if (!current_educator.can_set_districtwide_access) return null;
      ...
      <div className="lower-area-column">
        ...
        <div className="column-content">
          ...
          <ul>
            ...
            <li>
              <%= link_to 'Enrollment patterns', enrollment_district_url, {
                class: 'prominent-link'
              } %>
            </li>
            <li>
              <%= link_to 'Upload student services file', service_uploads_url, {
                class: 'prominent-link'
              } %>
            </li>
            <% if PerDistrict.new.enabled_student_voice_survey_uploads? && current_educator.labels.include?('can_upload_student_voice_surveys') %>
              <li>
                <%= link_to 'Upload student voice survey CSV', student_voice_survey_uploads_url, {
                  class: 'prominent-link'
                } %>
              </li>
            <% end %>
            ...
            <li>
              <a href={sample_students_url} className="prominent-link">
