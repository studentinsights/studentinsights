...
// Exports the description of the column and the ordering functions for
// re-use in exporting this data as a CSV.
export default class StudentConnectionsTable extends React.Component {
  constructor(props) {
    super(props);
...
StudentConnectionsTable.contextTypes = {
...
function renderSurveyResponse({rowData}) {
  return <span style={{textAlign: 'center'}}>{rowData.survey_response.shs_adult}</span>;
}
