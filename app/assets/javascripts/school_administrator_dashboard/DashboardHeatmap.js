...
export default class DashboardHeatmap extends React.Component{

  render() {
    return (
      <div id={this.props.id} className="DashboardHeatmap" style={styles.root}>
        <HighchartsWrapper
          style={{flex: 1}}
          chart={{
            type: 'heatmap',
