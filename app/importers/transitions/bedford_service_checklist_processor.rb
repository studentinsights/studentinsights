...
# importer = BedfordServiceChecklistProcessor.new(educator, homeroom, form_url)
# records = importer.create!(file_text);nil
class BedfordServiceChecklistProcessor
  ...
  def process_row_or_nil(row)
    ...
    #   @log.puts "BedfordServiceChecklistProcessor: homeroom does not match for student_id: #{student_id}"
    #   return nil
    # end
    ...
    #   @log.puts "BedfordServiceChecklistProcessor: provided educator does not match teacher name on sheet: #{teacher_last_name}"
    #   nil
    # end
