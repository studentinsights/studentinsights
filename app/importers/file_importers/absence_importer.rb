class AbsenceImporter
  ...
  def initialize(options:)
    ...
    @tardy_syncer = Syncer.new(log: @log)
    @absence_syncer = Syncer.new(log: @log)
  end
  ...
  def import
    ...
    @tardy_syncer.delete_unmarked_records!(records_within_scope(Tardy))
    @absence_syncer.delete_unmarked_records!(records_within_scope(Absence))
  end
  ...
  def import_row(row)
    ...
    syncer = { Absence: @absence_syncer, Tardy: @tardy_syncer }[record_class]
