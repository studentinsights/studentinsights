...
class EdPlanImporter
  ...
  def match_ed_plan(row)
    ...
    ed_plan.assign_attributes({
      ...
      sep_effective_date: row[:sep_effective_date],
      sep_review_date: row[:sep_review_date],
      sep_last_meeting_date: row[:sep_last_meeting_date],
      sep_district_signed_date: row[:sep_district_signed_date],
      sep_parent_signed_date: row[:sep_parent_signed_date],
      sep_end_date: row[:sep_end_date],
      sep_last_modified: row[:sep_last_modified],
