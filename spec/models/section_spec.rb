...
RSpec.describe Section, type: :model do
  ...
  context 'valid section' do
    ...
    let(:course) { FactoryBot.build(:course, course_number: course_number, course_description:course_description)}
    let(:section) { FactoryBot.build(:section, course: course) }
    it 'is valid' do
