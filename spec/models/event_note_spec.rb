  ...
  describe '#as_json' do
    ...
    describe 'with a relation including a restricted note' do
      it 'works normally when :text is not included' do
        ...
        expect(json).to eq([
          {"student_id"=>relation[0].student_id, "event_note_type_id"=>300},
          {"student_id"=>relation[1].student_id, "event_note_type_id"=>300},
          {"student_id"=>relation[2].student_id, "event_note_type_id"=>300}
        ])
      end
    ...
    describe 'with an array including a restricted note' do
      it 'works normally when :text is not included' do
        ...
        expect(json).to eq([
          {"student_id"=>array[0].student_id, "event_note_type_id"=>300},
          {"student_id"=>array[1].student_id, "event_note_type_id"=>300},
          {"student_id"=>array[2].student_id, "event_note_type_id"=>300}
        ])
      end
